...
export default function License() {
  return (
    <section
      id="license"
      className="relative py-14 px-4 sm:px-8 lg:px-16 bg-gradient-to-br from-green-50 to-white dark:from-gray-950 dark:to-gray-900 text-gray-900 dark:text-gray-100 overflow-hidden"
    >
      ...
      <div className="max-w-5xl mx-auto text-center">
       ...
       {/* Card */}
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl shadow-[0_20px_60px_-15px_rgba(0,128,0,0.2)] p-8 grid md:grid-cols-2 gap-10 items-center transform transition-all hover:scale-[1.015] duration-300 border border-green-100 dark:border-green-700 mb-18">
          {/* License Info */}
